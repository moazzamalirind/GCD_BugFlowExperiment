$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation 2018)
...
Num_Days(d)                          Number of days for each day type/Sunday 4, Saturday 5, Weekday 22/
;
...
Table Observed_Rel(d,p)"Releases (cfs) observed during March 2018"
                pLow      pHigh
Sunday        11493.54   12756.48
Saturday      11493.54   13738.06
Weekday       11407.70   15212.86;
...
Weekdays                       number of weekdays /22/
...
Execute_Unload "Valid_SatModel_March.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_March.gdx"
