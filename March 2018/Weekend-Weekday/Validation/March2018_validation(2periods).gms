...
release(p)                       Average release observed during each period (p) over the month (cfs) /pLow 11407.69886, pHigh 15212.85511/
...
Steady_Release                   Steady release value of the hydrograph /12699.05093/
...
Steady_Days                  The number of steady low flow days (weekend during March 2018)
;
...
*===================================================
$CALL GDXXRW.EXE input=Input_March_2018.xlsx output=Valid_March2018(2Periods).gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN Valid_March2018(2Periods).gdx
...
Execute_Unload "Valid_March2018(2Periods).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_March2018(2Periods).gdx"
