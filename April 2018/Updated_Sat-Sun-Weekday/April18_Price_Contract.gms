$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (April 2018- contract price Model)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st August 2018) (acre-ft)/12948951/
...
Execute_Unload "April_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls April_ContractPrice.gdx"
