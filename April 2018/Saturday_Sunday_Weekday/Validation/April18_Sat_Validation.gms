$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation  April 2018)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st April2018) (acre-ft)/12948951/
...
Num_Days(d)                          Number of days for each day type/Sunday 5, Saturday 4, Weekday 21/
;
...
Table Observed_Rel(d,p)"Releases (cfs) observed during April 2018"
                pLow      pHigh
Sunday        11287.95   10339.0
Saturday      11287.95   12800.9
Weekday       11081.62   13694.02 ;
...
Totaldays                      Number of days in the month /30/
Saturdays                      number of saturdays/4/
Sundays                        number of Sundays/5/
...
EQ6_Rel_Range(d)                     Constraining the daily release range but it will not work when NumDays will be zero(cfs per day)
...
Execute_Unload "Valid_SatModel_April.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_April.gdx"
