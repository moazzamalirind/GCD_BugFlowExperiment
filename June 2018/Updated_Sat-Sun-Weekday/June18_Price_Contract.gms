$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (June 2018- contract price Model)
...
Execute_Unload "June_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls June_ContractPrice.gdx"
