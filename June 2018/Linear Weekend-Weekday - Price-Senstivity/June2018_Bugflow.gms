...
$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Price_Senstivity June 2018)
...
EQ8_Steadyflow..                           Steady_Release=e=release("pLow")+ 1000;
