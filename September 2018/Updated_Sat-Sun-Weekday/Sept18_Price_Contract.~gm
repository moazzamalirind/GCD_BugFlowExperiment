$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (September 2018- contract price Model)
...
Saturdays(FlowPattern,d)              To represent the number of saturdays (i.e. steady flow saturdays and Hydropeak flow saturdays)
Sundays(FlowPattern,d)                To represent the number of Sundays (i.e. steady flow sundays and Hydropeak flow sundays)
Weekdays(FlowPattern,d)               To represent the number of weekdays (i.e. steady flow weekdays and Hydropeak flow weekdays)
...
Table Days_Distribution(FlowType,Days,Nu_SteadyDays) "number of steady and Hydropeak saturdays sundays and weekdays in the month"
...
***********************************************************************************************************************
** Note:  Steady weekday flows equal to steady Sundays (EQ 15).
...
EQ13a_OnPeak_Saturday(FlowPattern,d,p)$(Num_Days("HydroPeak","Saturday") gt 0)..      Release("HydroPeak","Saturday","pHigh")=e= Release("HydroPeak","Weekday","pHigh")-2000;
EQ13b_OnPeak_Sunday(FlowPattern,d,p)$(Num_Days("HydroPeak","Sunday") gt 0)..       Release("HydroPeak","Sunday","pHigh")=e= Release("HydroPeak","Saturday","pHigh");
...
Execute_Unload "Sept_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Sept_ContractPrice.gdx"
