...
Execute_Unload "Sat-Sun-Weekday_September.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Sat-Sun-Weekday_September.gdx"


*The constrained model makes off-peak releases during Saturday, Sunday and Weekday equal. Activate equations 11 and 13
*Dump all input data and results to a GAMS gdx file
*Execute_Unload "Constrained_September.gdx";
* Dump the gdx file to an Excel workbook
*Execute "gdx2xls Constrained_September.gdx"
