$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation  September 2018)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st April2018) (acre-ft)/11458588/
...
Num_Days(d)                          Number of days for each day type/Sunday 5, Saturday 5, Weekday 20/
;
...
Table Observed_Rel(d,p)"Releases (cfs) observed during September 2018"
                pLow      pHigh
Sunday        10316.88   10688.22
Saturday      10316.88   12169.94
Weekday       10028.41   12811.5 ;
...
Weekdays                       number of weekdays /20/
...
Execute_Unload "Valid_SatModel_September.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_September.gdx"
