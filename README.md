...
1. Download folder named "Validation" available at GCD_BugFlowExperiment/Months of 2018/March 2018/Contract Price Model/Validation (https://github.com/moazzamalirind/GCD_BugFlowExperiment/tree/main/Months%20of%202018/March%202018/Contract%20Price%20Model) and save downloaded folder at your desired location. With this folder you will find files with extensions like,  .gms, .log, .lst, .lxi, .xlsx, .gpr. 

 a) Hourly model (hourly releases and energy prices are model inputs) b) Saturday-Sunday-Weekday model (periodic releases and energy prices for different daytypes are model inputs). Note: Details of the hourly releases and energy prices, as well as, estimation of periodic releases and energy prices are present in excel file " Input_August2018.xlsx".
