$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (July 2018- contract price Model)
...
Execute_Unload "July_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls July_ContractPrice.gdx"
