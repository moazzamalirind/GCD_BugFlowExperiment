...
release(p)                       Average release observed during each period (p) over the month (cfs) /pLow 12497.2, pHigh 16750.14/
...
Steady_Release                   Steady release value of the hydrograph (cfs) /11649.9/
...
Steady_Days                  The number of steady low flow days (weekend during July 2018)
;
...
weekdays                      Number of Weekdays in month/22/
...
Execute_Unload "Valid_July2018(2Periods).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_July2018(2Periods).gdx"
