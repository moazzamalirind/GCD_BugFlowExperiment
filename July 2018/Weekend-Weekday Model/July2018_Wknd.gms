...
EnergyRate(p)                         Energy prices on weekdays ($ per MWH) /pLow 46.548, pHigh 80.077/
weekendRate(p)                        Energy prices on weekends ($ per MWH) /pLow 46.548, pHigh 46.548/
Duration(p)                           Duration of period (hours)
Vol_monthlyrelease(tot_vol)           Different Total volumes of water to be released in the month i.e. July 2018 in presented case (acre-ft)/V1 700000,V2 800000,V3 900000,V4 1000000,V5 1100000/
...
*===================================================
$CALL GDXXRW.EXE input=Input_July2018.xlsx output=July2018(Weekend).gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN July2018(Weekend).gdx
...
Execute_Unload "July2018(Weekend).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls July2018(Weekend).gdx"
