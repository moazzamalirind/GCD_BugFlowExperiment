$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation  July 2018)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st April2018) (acre-ft)/12711184/
...
Num_Days(d)                          Number of days for each day type/Sunday 5, Saturday 4, Weekday 22/
;
...
Table Observed_Rel(d,p)"Releases (cfs) observed during July 2018"
                pLow      pHigh
Sunday        12150.69   11398.13
Saturday      12150.69   11401.17
Weekday       12497.16   16750.14 ;
...
Execute_Unload "Valid_SatModel_July.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_July.gdx"
