$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Market and contract pricing May 2018)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st May 2018) (acre-ft)/12658966/
* Storage data for lake Powell can be found at: http://lakepowell.water-data.com/index2.php

Inflow                                Average monthly Inflow to reservoir (cfs) /14032/
...
evap                                  Evaporation (ac-ft per Month) /29000/
...
Table Energy_PriceBase(d,Price,p)"Price of MegaWatt hour during different days and within period p ($ per MWh)"
                      pLow        pHigh
Sunday.Contract       35.96       35.96
Sunday.Market         35.96       35.96
Saturday.Contract     35.96       46.56
Saturday.Market       35.96       46.56
Weekday.Contract      35.96       57.16
Weekday.Market        35.96       57.16;
...
*Introducing market price in the following lines.
