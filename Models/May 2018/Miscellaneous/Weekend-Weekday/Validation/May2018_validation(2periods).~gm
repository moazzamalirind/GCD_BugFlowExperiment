...
$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (May 2018)
...
release(p)                       Average release observed during each period (p) over the month (cfs) /pLow 10502.92, pHigh 13724.68/
...
Steady_Release                   Steady release value of the hydrograph (cfs) /9561.5/
...
EnergyRate(p)                Energy prices on weekdays ($ per MWH) /pLow 35.96, pHigh 57.1597/
weekendRate(p)               Energy prices on weekends ($ per MWH) /pLow 35.96, pHigh 35.96/
Duration(p)                  Duration of period (hours)
Steady_Days                  The number of steady low flow days (weekend during May 2018)
;
...
*===================================================
$CALL GDXXRW.EXE input=Input_May2018.xlsx output=Valid_May2018(2Periods).gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN Valid_May2018(2Periods).gdx
...
Execute_Unload "Valid_May2018(2Periods).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_May2018(2Periods).gdx"
