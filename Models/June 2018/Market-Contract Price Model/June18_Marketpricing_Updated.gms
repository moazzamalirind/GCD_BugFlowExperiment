$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Market and contract pricing June 2018)
...
Observed_Rel(Days,p)                                          Observed hydropeaking releases for day types during periods(cfs)
...
Table Energy_PriceBase(d,Price,p)"Price of MegaWatt hour during different days and within period p ($ per MWh)"
                      pLow        pHigh
Sunday.Contract       37.70       37.70
Sunday.Market         37.70       37.70
Saturday.Contract     37.70       50.61
Saturday.Market       37.70       50.61
Weekday.Contract      37.70       63.52
Weekday.Market        37.70       63.52;
