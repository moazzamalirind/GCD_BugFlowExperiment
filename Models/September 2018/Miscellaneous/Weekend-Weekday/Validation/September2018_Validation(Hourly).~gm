...
$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population (September 2018)
...
initstorage                  Initial reservoir storage on 1st September 2018 (acre-ft)/11458588/
...
observed_release(d,p)        observed release during September 2018 averaged over hourly timestep (cfs)
...
*===================================================
$CALL GDXXRW.EXE input=Input_September2018.xlsx  output= Valid_September2018(Hourly).gdx  par=observed_release rng=Observed_Release(Hr)!A1:Y32 par=EnergyRate rng=Rates!A1 Rdim=1  set=d rng=day!A1 Rdim=1  par=Inflow rng=inflow!A1 Rdim=1 par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN Valid_September2018(Hourly).gdx
...
*For validation only, here we are ignoring the minimum release constraint because some of the days has flows below 8000 cfs.
...
Execute_Unload "Valid_September2018(Hourly).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_September2018(Hourly).gdx"
