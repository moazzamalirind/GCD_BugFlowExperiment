$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Market and contract pricing September 2018)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st September 2018) (acre-ft)/11458588/
* Storage data for lake Powell can be found at: http://lakepowell.water-data.com/index2.php

Inflow                                Average monthly Inflow to reservoir (cfs) /3858.2/
...
evap                                  Evaporation (ac-ft per Month) /44783/
...
Table Energy_PriceBase(d,Price,p)"Price of MegaWatt hour during different days and within period p ($ per MWh)"
                      pLow        pHigh
Sunday.Contract       52.19       52.19
Sunday.Market         52.19       52.19
Saturday.Contract     52.19       61.10
Saturday.Market       52.19       61.10
Weekday.Contract      52.19       70.01
Weekday.Market        52.19       70.01;
