...
Sunday.Market         43.24       43.24
Saturday.Contract     38.24       46.70
Saturday.Market       43.24       51.70
Weekday.Contract      38.24       55.05
Weekday.Market        43.24       60.05;
...
EQ23_Unbounded(d,p)                              To tackle Unbounded ray error in case of flat hydrograph
...
EQ23_Unbounded(d,p)$(Num_Days("Hydropeak","Weekday") eq 0)..                                                                   Revenue("HydroPeak",d,p)=e=0;
