...
EQ14_EnergyRevenue(f)$(ord(f) eq 2)..         ObjectiveVal(f)=e= Obj_dir(f)* sum((d,p),Energy_Gen(d,p)*EnergyRate(d,p));
...
Execute_Unload "June18_dailycv.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls June18_dailycv.gdx"
