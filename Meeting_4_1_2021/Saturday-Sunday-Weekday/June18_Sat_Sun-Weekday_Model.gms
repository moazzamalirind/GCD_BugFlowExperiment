...
* Dump all input data and results to a GAMS gdx file
*Execute_Unload "Unconstrained_eq17_Model.gdx";
* Dump the gdx file to an Excel workbook
*Execute "gdx2xls Unconstrained_eq17_Model.gdx"
...
*Model without equation 17
* Dump all input data and results to a GAMS gdx file
*Execute_Unload "Minus17_Model.gdx";
* Dump the gdx file to an Excel workbook
*Execute "gdx2xls Minus17_Model.gdx"
