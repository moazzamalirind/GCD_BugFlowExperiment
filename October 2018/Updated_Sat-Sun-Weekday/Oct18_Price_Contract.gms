$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (October 2018- contract price Model)
...
Execute_Unload "October_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls October_ContractPrice.gdx"
