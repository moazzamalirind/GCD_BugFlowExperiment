...
Weekend_Rel                           Additional release made on weekend off-peak incomparison to weekday off-peak release(cfs)--Offset release.
...
Execute_Unload "Sat-Sun-Weekday_June.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Sat-Sun-Weekday_June.gdx"
