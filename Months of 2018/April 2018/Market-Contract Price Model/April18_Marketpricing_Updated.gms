$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Market and contract pricing April 2018)
...
Set
          ...
          Offset                        Scenarios of offset releases between off-peak Hydropeak day and steady day releases /H1*H4/
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st April 2018) (acre-ft)/12948951/
* Storage data for lake Powell can be found at: http://lakepowell.water-data.com/index2.php

Inflow                                Average monthly Inflow to reservoir (cfs) /7049.94/
...
evap                                  Evaporation (ac-ft per Month) /24695/
...
Steady. Weekday           0       0        0       0      0        0      1       2      4       7        12        17        22
HydroPeak. Weekday        22      22       22      22     22       22     21      20     18      15       10         5         0 ;
...
Table Energy_PriceBase(d,Price,p)"Price of MegaWatt hour during different days and within period p ($ per MWh)"
                      pLow        pHigh
Sunday.Contract       38.24       38.24
Sunday.Market         38.24       38.24
Saturday.Contract     38.24       46.70
Saturday.Market       38.24       46.70
Weekday.Contract      38.24       55.05
Weekday.Market        38.24       55.05;
