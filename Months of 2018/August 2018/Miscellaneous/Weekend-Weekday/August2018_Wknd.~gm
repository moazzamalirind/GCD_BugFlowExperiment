...
Vol_monthlyrelease(tot_vol)           Different Total volumes of water to be released in the month i.e. August 2018 in presented case (acre-ft)/V1 719449.7,V2 827034,V3 944701.8,V4 1000000,V5 1100000/
TotMonth_volume                       To represent total monthly volume (acre-ft)
Steady_Days                           To represent the number of steady low flow days
Num_steady(case)                      Number of steady low flow days/case1 0, case2 1,case3 2, case4 4, case5 6, case6 8,case7 9,case8 10,case9 15,case10 20,case11 25,case12 31/
...
*===================================================
$CALL GDXXRW.EXE input=Input_August2018.xlsx output=August2018(Weekend).gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN August2018(Weekend).gdx
...
*this Model will work under scenarios when number of steady low bug flow days are less than or equal to number of weekend days.
...
*********************************************************************
   ...
   ModelResults(Wkn,tot_vol,"case6","SolStat")= Model2.solvestat;
   ModelResults(Wkn,tot_vol,"case6","ModStat")= Model2.modelstat;
...
Execute_Unload "August2018(Weekend).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls August2018(Weekend).gdx"
