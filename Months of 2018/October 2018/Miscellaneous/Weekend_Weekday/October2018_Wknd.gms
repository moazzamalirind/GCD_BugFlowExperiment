...
Vol_monthlyrelease(tot_vol)           Different Total volumes of water to be released in the month i.e. October 2018 in presented case (acre-ft)/V1 700000,V2 800000,V3 900000,V4 1000000,V5 1100000/
...
*===================================================
$CALL GDXXRW.EXE input=Input_October2018.xlsx output=October2018(Weekend).gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN October2018(Weekend).gdx
...
Execute_Unload "October2018(Weekend).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls October2018(Weekend).gdx"
