...
release(p)                       Average release observed during each period (p) over the month (cfs) /pLow 8872.30, pHigh 11686.05/
...
Steady_Release                   Steady release value of the hydrograph (cfs) /10096.77/
...
*===================================================
$CALL GDXXRW.EXE input=Input_October2018.xlsx output=Valid_October2018(2Periods).gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN Valid_October2018(2Periods).gdx
...
Execute_Unload "Valid_October2018(2Periods).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_October2018(2Periods).gdx"
