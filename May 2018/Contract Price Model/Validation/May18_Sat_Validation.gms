$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation  May 2018)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st April2018) (acre-ft)/12658966/
...
Table Observed_Rel(d,p)"Releases (cfs) observed during May 2018"
                pLow      pHigh
Sunday        10162.03   9245.39
Saturday      10162.03   9277.03
Weekday       10502.92   13724.68 ;
...
Execute_Unload "Valid_SatModel_May.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_May.gdx"
