$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (May 2018- contract price Model)
...
Initstorage                           Initial reservoir storage (e.g Storage in Powell on 1st March 2018) (acre-ft)/12658966/
...
Execute_Unload "May_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls May_ContractPrice.gdx"
