$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Partial August 2018)
...
Execute_Unload "Sat-Sun-Weekday_August(Partial).gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Sat-Sun-Weekday_August(Partial).gdx"
