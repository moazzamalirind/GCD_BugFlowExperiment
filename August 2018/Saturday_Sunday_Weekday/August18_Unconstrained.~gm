$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Unconstrianed August 2018)
...
*Dump all input data and results to a GAMS gdx file
*Execute_Unload "Sat-Sun-Weekday_August.gdx";
* Dump the gdx file to an Excel workbook
*Execute "gdx2xls Sat-Sun-Weekday_August.gdx"
