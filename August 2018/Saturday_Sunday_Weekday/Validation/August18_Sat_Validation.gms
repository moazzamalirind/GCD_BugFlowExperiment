$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. ( Saturday-Sunday-Weekday model Validation  August 2018)
...
Table Observed_Rel(d,p)"Releases (cfs) observed during August 2018"
                pLow      pHigh
Sunday        12736.72   11024.26
Saturday      12736.72   11646.88
Weekday       13137.8    17211.28 ;
...
Execute_Unload "Valid_SatModel_August.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Valid_SatModel_August.gdx"
