...
$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (Price_Senstivity August 2018)
...
Set
          ...
          Wkn                           Scenarios to decide the change between off-peak release on weekday and weekend steady flows /H1*H2/
;
...
weekendRate(p)                        Energy prices on weekends ($ per MWH) /pLow 69.2, pHigh 69.2/
...
Diff_Release(Wkn)                     Differnce between off-peak weekday release and weekend release(cfs)/H1 0, H2 1000/
;
...
*===================================================
$CALL GDXXRW.EXE input=Input_August2018.xlsx output=PriceSen_Aug2018.gdx set=d rng=day!A1 Rdim=1 par=Inflow rng=inflow!A1 Rdim=1  par=evap rng=Evaporation!A1 Rdim=1

*Write the input Data into a GDX file
$GDXIN PriceSen_Aug2018.gdx
...
Execute_Unload "PriceSen_Aug2018.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls PriceSen_Aug2018.gdx"
