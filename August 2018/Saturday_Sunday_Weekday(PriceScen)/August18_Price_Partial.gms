$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (August 2018- Pricing Scenario_ Partial Model)
...
Execute_Unload "Partial_AugPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Partial_AugPrice.gdx"
