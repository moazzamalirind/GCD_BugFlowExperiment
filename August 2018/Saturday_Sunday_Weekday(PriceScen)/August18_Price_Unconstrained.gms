$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (August 2018- Pricing Scenario)
...
*control the unsteady Saturaday and Sunday releases except it only has minimum release constriant. (comment out equation 11 and equation 13 to make the model unconstrianed)
*Dump all input data and results to a GAMS gdx file
Execute_Unload "Unconstrained_AugPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Unconstrained_AugPrice.gdx"
