$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (August 2018- Validation)
...
Set
          ...
          tot_vol                       Total montly release volume  (acre-ft)/V1/
...
Vol_monthlyrelease(tot_vol)           Different monthyl release Volumes (acre-ft)/V1 944701/
...
Execute_Unload "August_Validation.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls August_Validation.gdx"
