$ontext
Title Optimization model for Glen Canyon Dam releases to favor Bugs population. (August 2018- contract price Model)
...
Execute_Unload "August_ContractPrice.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls August_ContractPrice.gdx"
