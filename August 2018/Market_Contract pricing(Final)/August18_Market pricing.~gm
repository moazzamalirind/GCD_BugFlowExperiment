...
Vol_monthlyrelease(tot_vol)           Different monthyl release Volumes (acre-ft)/V1 700000,V2 800000,V3 900000/
...
*The release volume of August 2017 was 0.93 MAF.
              pLow        pHigh
...
EQ13_SteadyFlow_Day(FlowPattern,d)               Constraining on-peak and off-peak releases during Steadyflow day to be equal (cfs)
EQ14_OffsetRel(FlowPattern)                      Offset release between off-peak unsteady weekday and off-peak steady weekend (saturday or and sunday)releses(cfs)

EQ15_OnPeak_Saturday(FlowPattern,d,p)           On-peak Saturday constraint. i.e. Weekend on-peak minus 2000 cfs (found this value from observed hydrographs of 2015 2016 2017).
EQ15a_offpeak_Saturday(FlowPattern,d,p)         Off-peak Saturday constraint (cfs)
EQ16_OnPeak_Sunday(FlowPattern,d,p)             On-peak Sunday constraint. i.e.  equal to Saturday On-peak.
EQ16a_offpeak_Sunday(FlowPattern,d,p)            Off-peak Sunday constraint (cfs)

EQ17_Steady_Saturdays(FlowPattern,d,p)           Constraining the steady Saturday flows equal to steady sundays flows (cfs)

** here I am assuming that steady weekday equals to steady sundays.
EQ18_Steady_Weekdays(FlowPattern,d,p)            Constraining the steady weekdays flows equal to steady sundays flows (cfs)

EQ19_OnPeak_UnsteadyDay(FlowPattern,d)          Constraining on-peak unsteady day release to be greater than off-peak unsteady release on the same day (cfs)
...
*$ontext
EQ22_Unsteady_WeekdayRev                        Revenue generated during unsteady Weekday ($).  For scenarios with  steady low flow weekdays($)
EQ23_Unsteady_SatRev_onpeak                     Revenue generated during unsteady Saturday during on peak ($)
EQ24_Unsteady_SatRev_offpeak                    Revenue generated during unsteady Saturday during off peak ($)
EQ25_Unsteady_SundayRev_onpeak                  Revenue generated during unsteady Sunday during on peak   ($)
EQ26_Unsteady_SundayRev_offpeak                 Revenue generated during unsteady Saturday during off peak ($)
EQ27_Steadydays_Onpeak                          Revenue generated during on-peak Steadyday ($).
EQ28_Steadydays_Offpeak                         Revenue generated during off-peak Steadyday ($)
*$offtext

EQ29_TotalRevenue                                Total monthly Hydropower Revenue generated($). The revenue has all daytypes and all flowpatterns with both market and contract prices.
;
...
EQ13_SteadyFlow_Day(FlowPattern,d)..                                           Release("Steady",d,"pHigh") =e= Release("Steady",d,"pLow");
...
EQ15_OnPeak_Saturday(FlowPattern,d,p)$((Num_days("HydroPeak","Saturday") gt 0) and (Num_Days("Steady","Saturday") lt 4))..                  Release("HydroPeak","Saturday","pHigh")=g= Release("HydroPeak","Weekday","pHigh")-2000;
EQ15a_offpeak_Saturday(FlowPattern,d,p)$((Num_days("HydroPeak","Saturday") gt 0) and (Num_Days("Steady","Saturday") lt 4))..               Release("HydroPeak","Saturday","pLow")=e=  Release("HydroPeak","Weekday","pLow");

EQ16_OnPeak_Sunday(FlowPattern,d,p)$((Num_days("HydroPeak","Sunday") gt 0) and (Num_Days("Steady","Sunday") lt 4))..                        Release("HydroPeak","Sunday","pHigh")=g= Release("HydroPeak","Saturday","pHigh");
EQ16a_offpeak_Sunday(FlowPattern,d,p)$((Num_days("HydroPeak","Sunday") gt 0) and (Num_Days("Steady","Sunday") lt 4))..                     Release("HydroPeak","Sunday","pLow")=e= Release("HydroPeak","Weekday","pLow");
...
EQ25_Unsteady_SundayRev_onpeak(FlowPattern,d,p)$((Num_Days("Steady","Sunday") gt 0)and(Num_Days("Hydropeak","Sunday") gt 0))..              Revenue("HydroPeak","Sunday","pHigh")=e=  [{ Release("HydroPeak","Sunday","pHigh")* Energy_Price("Sunday","Contract","pHigh")-(Nobugflow_Rel("Sunday","pHigh")-Release("HydroPeak","Sunday","pHigh"))*Energy_Price("Sunday","Market","pHigh")}*Duration("pHigh")*0.03715]* Num_Days("HydroPeak","Sunday");

EQ26_Unsteady_SundayRev_offpeak(FlowPattern,d,p)$((Num_Days("Steady","Sunday") gt 0)and(Num_Days("Hydropeak","Sunday") gt 0))..             Revenue("HydroPeak","Sunday","pLow")=e=  [{ Nobugflow_Rel("Sunday","pLow")* Energy_Price("Sunday","Contract","pLow")+(Release("HydroPeak","Sunday","pLow")- Nobugflow_Rel("Sunday","pLow"))*Energy_Price("Sunday","Market","pLow")}*Duration("pLow")*0.03715]* Num_Days("HydroPeak","Sunday");
*=====================================================================================
