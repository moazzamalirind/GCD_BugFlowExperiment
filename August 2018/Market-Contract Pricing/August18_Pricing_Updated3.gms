...
Set
          ...
          Offset                        Scenarios of offset releases between off-peak unsteady day and steady day releases /H1/
;
...
Diff_Release(Offset)                  Differnce between off-peak weekday release and weekend release(cfs)/H1 1000/
...
Nobugflow_Rel(d,p)                                            Releases from no steady low flow day (prebugflow hydrograph) model (cfs)
...
Table Zerosteady_Rel(d,p,tot_vol)" Releases from zero steady low flow model--prebugflow hydrograph(cfs)"
                  V1           V2           V3         V4            V5
Sunday.pLow       8000         8000         8000       8000          8000
Sunday.pHigh      8000         8000         8000       8000          8000
Saturday.pLow     8000         9145.9       11005.2    12864.5       14723.8
Saturday.pHigh    8000         9145.9      11005.2    12864.5       14723.8
Weekday.pLow      8000         9145.9      11005.2    12864.5       14723.8
Weekday.pHigh     14743.8      17145.9     19005.2    20864.5       22723.8;
...
*EQ21a is not required for possibilty 3. Instead following two equations: EQ21AA and EQBB are required

EQ21AA_Unsteady_WeekdayRev_onpeak                  Revenue generated during unsteady and Steady Weekday during on peak ($)
EQ21BB_Unsteady_WeekdayRev_offpeak                 Revenue generated during unsteady Weekday during off peak ($)
*EQ21CC_Steady_WeekdayRev_offpeak                   Revenue generated during Steadty Weekday during off peak ($)


*For possibility three all the following equations are applicable for both flow patterns. I am not changing names because it can confuse the reader when he try to use possibility one or two.
...
EQ7c_AlternativeDays_Relrange$(Num_days("HydroPeak","Sunday") gt 0)..          Release("HydroPeak","Sunday","pHigh")- Release("HydroPeak","Weekday","pLow")=l=Daily_RelRange;
...
*EQ11_Unsteadydays_OffpeakRel(FlowPattern,d)$(Num_Days("HydroPeak",d) gt 0)..    Release("HydroPeak",d,"pLow")=e= Release("HydroPeak","Weekday","pLow");


EQ12_OffsetRel(FlowPattern)$((Num_days("HydroPeak","Weekday") gt 0) and (Num_Days("Steady","Sunday") gt 0))..          Release("Steady","Sunday","pLow")=e= Release("HydroPeak","Weekday","pLow")+ Weekend_Rel;
...
*EQ13_Zero_OffsetRel(FlowPattern,d,p)$(Num_Days("Steady","Sunday") eq 0)..      Release("HydroPeak",d,p)=e= Release("HydroPeak","Weekday",p);
...
*EQ16_Steady_Weekdays(FlowPattern,d,p)$((Num_Days("Steady","Weekday")gt 0)and(Num_Days("HydroPeak","Weekday")gt 0))..     Release("Steady","Weekday",p)=e= Release("Steady","Sunday",p)- Weekend_Rel ;


EQ17_OnPeak_UnsteadyDay(FlowPattern,d)$(Num_Days("HydroPeak",d)gt 0)..          Release("HydroPeak",d,"pHigh")=g= Release("HydroPeak",d,"pLow");
...
*=====================================================================================
*possibility no:3
* I am assuming results from zero steady low flow scenario as no bugflow releases.
*$ontext
*pHigh unsteady and steady weekday less than no-bug flow release.
EQ21AA_Unsteady_WeekdayRev_onpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..            Revenue(FlowPattern,"Weekday","pHigh")=e= [{Release(FlowPattern,"Weekday","pHigh")* Energy_Price("Weekday","Contract","pHigh")-(Nobugflow_Rel("Weekday","pHigh")- Release(FlowPattern,"Weekday","pHigh") )*Energy_Price("Weekday","Market","pHigh")}*0.03715*Duration("pHigh")]* Num_Days(FlowPattern,"Weekday");

*pLow Unsteady weekday greater than no-bug flow release.
EQ21BB_Unsteady_WeekdayRev_offpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..           Revenue(FlowPattern,"Weekday","pLow")=e= [{ Nobugflow_Rel("Weekday","pLow")* Energy_Price("Weekday","Contract","pLow")+ (Release(FlowPattern,"Weekday","pLow")- Nobugflow_Rel("Weekday","pLow"))*Energy_Price("Weekday","Market","pLow")}*0.03715*Duration("pLow")]* Num_Days(FlowPattern,"Weekday");

*pLow Unsteady weekday less than no-bug flow release.
*EQ21BB_Unsteady_WeekdayRev_offpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..           Revenue("Hydropeak","Weekday","pLow")=e= [{ Release("Hydropeak","Weekday","pLow") * Energy_Price("Weekday","Contract","pLow")- (Nobugflow_Rel("Weekday","pLow")-Release("Hydropeak","Weekday","pLow"))*Energy_Price("Weekday","Market","pLow")}*0.03715*Duration("pLow")]* Num_Days("Hydropeak","Weekday");

*pLow Steady weekday greater than no-bug flow release.
*EQ21CC_Steady_WeekdayRev_offpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..             Revenue("Steady","Weekday","pLow")=e= [{ Nobugflow_Rel("Weekday","pLow")* Energy_Price("Weekday","Contract","pLow")+ (Release("Steady","Weekday","pLow")- Nobugflow_Rel("Weekday","pLow"))*Energy_Price("Weekday","Market","pLow")}*0.03715*Duration("pLow")]* Num_Days("Steady","Weekday");


*All releases (Saturday and Sunday will be higher than no bug flow).
EQ21b_Unsteady_SaturdayRev_onpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..            Revenue(FlowPattern,"Saturday","pHigh") =e=  [{ Nobugflow_Rel("Saturday","pHigh") * Energy_Price("Saturday","Contract","pHigh")+(Release(FlowPattern,"Saturday","pHigh")- Nobugflow_Rel("Saturday","pHigh"))*Energy_Price("Saturday","Market","pHigh")}*Duration("pHigh")*0.03715]* Num_Days(FlowPattern,"Saturday");

EQ21c_Unsteady_SaturdayRev_offpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..           Revenue(FlowPattern,"Saturday","pLow")=e=  [{ Nobugflow_Rel("Saturday","pLow") * Energy_Price("Saturday","Contract","pLow")+(Release(FlowPattern,"Saturday","pLow")- Nobugflow_Rel("Saturday","pLow"))*Energy_Price("Saturday","Market","pLow")}*Duration("pLow")*0.03715]* Num_Days(FlowPattern,"Saturday");

EQ21d_Unsteady_SundayRev_onpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..              Revenue(FlowPattern,"Sunday","pHigh")=e=  [{ Nobugflow_Rel("Sunday","pHigh")* Energy_Price("Sunday","Contract","pHigh")+(Release(FlowPattern,"Sunday","pHigh")- Nobugflow_Rel("Sunday","pHigh"))*Energy_Price("Sunday","Market","pHigh")}*Duration("pHigh")*0.03715]* Num_Days(FlowPattern,"Sunday");

EQ21e_Unsteady_SundayRev_offpeak(FlowPattern,d,p)$(Num_Days("Steady","Sunday") gt 0)..             Revenue(FlowPattern,"Sunday","pLow")=e=  [{Nobugflow_Rel("Sunday","pLow") * Energy_Price("Sunday","Contract","pLow")+(Release(FlowPattern,"Sunday","pLow") - Nobugflow_Rel("Sunday","pLow"))*Energy_Price("Sunday","Market","pLow")}*Duration("pLow")*0.03715]* Num_Days(FlowPattern,"Sunday");
*$offtext
*=====================================================================================
...
Nobugflow_Rel(Days,p) =Zerosteady_Rel(Days,p,tot_vol);
...
EQ21_ZeroBugDays_Revenue$(Num_Days("Steady","Sunday") eq 0)..            Revenue_zeroSteadyFlow =e= sum(FlowPattern,sum(d, sum(p,Energy_Gen(FlowPattern,d,p)*Energy_Price(d,"Contract",p))*Num_Days(FlowPattern,d)));
...
* Dump all input data and results to a GAMS gdx file
Execute_Unload "Pricing_Model_poss3.gdx";
* Dump the gdx file to an Excel workbook
Execute "gdx2xls Pricing_Model_poss3.gdx"
